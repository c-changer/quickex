...
ALLOWED_HOSTS = ['38.180.38.173', 'quickex.cc', 'www.quickex.cc', '0.0.0.0', '127.0.0.1']
...
CSRF_TRUSTED_ORIGINS = ["https://www.quickex.cc", "https://quickex.cc"]
CSRF_COOKIE_DOMAIN = 'quickex.cc'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "quickex.cc",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "quickex.cc",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "quickex.cc",
    ...
    "welcome_sign": "Welcome to the quickex.cc Admin Panel",

    # Copyright on the footer
    "copyright": "quickex.cc",
